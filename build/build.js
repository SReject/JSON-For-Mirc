(function (buildjson, source, output) {
    ...
    try {
        ...
        } else if (Object.prototype.toString.call(files.js) !== "[object Array]") {
        ...
        } else if (Object.prototype.toString.call(files.msl) !== "[object Array]") {
        ...
        result = {error: ee.message + ": " + errorMsg, result: null};
    }
}(__PARAMETERS__));